...
<section id="experience" data-theme-section="light" class="about_home_wrap u-theme-light">
  ...
  <div class="about_home_contain">
    ...
    <div class="w-dyn-list" style="width: 100%;">
      <div role="list" class="w-dyn-items" style="display: flex; flex-direction: column; gap: 3rem;">
  ...
  console.log("Successfully updated the Experience section styling and ordering.");
} else {
